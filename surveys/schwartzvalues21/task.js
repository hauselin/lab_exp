...
const taskinfo = {
    ...
    uniquestudyid: 'schwartzvalues21', // unique task id: must be IDENTICAL to directory name
    desc: 'Schwartz human values 21-item', // brief description of task
    condition: null, // experiment/task condition
    redirect_url: "/surveys/schwartzvalues21/viz" // set to false if no redirection required
};
...
var instructions = {
    ...
    pages: [
        ...
        generate_html("You'll read several descriptions. For each one, please answer the following question.", font_colour) +
        generate_html("<strong>How much like you is this person?</strong>", font_colour)
    ],
...
var timeline = [];
var html_path = "../../surveys/schwartzvalues21/consent.html";  // make it a global variable
